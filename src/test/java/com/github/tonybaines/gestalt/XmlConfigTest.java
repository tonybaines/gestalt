...
public class XmlConfigTest {
  ...
  public void readsAnXmlConfigFileAndMakesThePropertiesAvailable() {
    ...
    testConfig.getAllTheThings().stream()
      .anyMatch(someThing -> someThing.getId().equals("alpha"));
  }
  ...
  public void constantsCanBeInjectedFromAPropertiesObject() throws Exception {
    EnclosingInterface config = Configurations
      ...
      .fromGroovyConfigResource("simple-config-with-constant-refs.grc")
  ...
  public void anUndefinedChildConfigValueRevertsToDefaultValue() throws Exception {
    EnclosingInterface config = Configurations.definedBy(EnclosingInterface.class)
